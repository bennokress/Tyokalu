...
1. [Save for Later](Save%20for%20Later.md) - Sort saved content into categories based on the URL
2. [Save to Cloud Storage](Save%20to%20Cloud%20Storage.md) - Sort files by type before uploading to cloud storage
3. [Ask AI](Ask%20AI.md) - Send files, websites, or text to an AI for quick answers
...
9. [App Icon Downloader](App%20Icon%20Downloader.md) - Download an app's icon from the App Store
...
6. [CarPlay Navigation](CarPlay%20Navigation.md) - Navigate to the next calendar event or home when CarPlay connects
